document.getElementById("slanje").onclick = function (event)
{
    ...
    var polje_za_kratki_sardzaj = document.getElementById("shortend-content");
         ...
         {
            slanje_forme = false;
             document.getElementById("porukaKratkiSardzaj").innerHTML = "<br>Kratki sadrzaj vijesti mora imati više<br>od 10 i manje od 100 znakova.";
    ...
    var polje_za_tekst = document.getElementById("content");
        ...
        {
            slanje_forme = false;
            document.getElementById("porukaSadrzaj").innerHTML = "<br>Tekst vijesti ne smiije biti prazan.<br>Molim Vas unesite tekst.";
    ...
    var polje_za_slika = document.getElementById("picture");
        ...
        {
            slanje_forme = false;
            document.getElementById("porukaSlika").innerHTML = "<br>Molim Vas odaberite sliku.";
    ...
    var polje_za_kategorija = document.getElementById("category");
        ...
        {
            slanje_forme = false;
            document.getElementById("porukaKategorija").innerHTML = "<br>Molim Vas odaberite kategoriju.";
